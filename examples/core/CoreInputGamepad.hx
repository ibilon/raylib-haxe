...
class CoreInputGamepad
{
	static function main()
	{
		// NOTE: Gamepad name ID depends on drivers and OS
		var XBOX360_NAME_ID = PLATFORM_RPI ? "Microsoft X-Box 360 pad" : "Xbox 360 Controller";
		var PS3_NAME_ID = PLATFORM_RPI ? "PLAYSTATION(R)3 Controller" : "PLAYSTATION(R)3 Controller";
			...
			BeginDrawing();
				...
				if (IsGamepadAvailable(GAMEPAD_PLAYER1))
				{
					...
					if (IsGamepadName(GAMEPAD_PLAYER1, XBOX360_NAME_ID))
					{
						...
						DrawCircle(Std.int(259 + (GetGamepadAxisMovement(GAMEPAD_PLAYER1, GAMEPAD_XBOX_AXIS_LEFT_X)*20)), Std.int(152 - (GetGamepadAxisMovement(GAMEPAD_PLAYER1, GAMEPAD_XBOX_AXIS_LEFT_Y)*20)), 25, BLACK);

						// Draw axis: right joystick
						DrawCircle(461, 237, 38, BLACK);
						DrawCircle(461, 237, 33, LIGHTGRAY);
						DrawCircle(Std.int(461 + (GetGamepadAxisMovement(GAMEPAD_PLAYER1, GAMEPAD_XBOX_AXIS_RIGHT_X)*20)), Std.int(237 - (GetGamepadAxisMovement(GAMEPAD_PLAYER1, GAMEPAD_XBOX_AXIS_RIGHT_Y)*20)), 25, BLACK);

						// Draw axis: left-right triggers
						DrawRectangle(170, 30, 15, 70, GRAY);
						DrawRectangle(604, 30, 15, 70, GRAY);
						DrawRectangle(170, 30, 15, Std.int(((1.0 + GetGamepadAxisMovement(GAMEPAD_PLAYER1, GAMEPAD_XBOX_AXIS_LT))/2.0)*70), RED);
						DrawRectangle(604, 30, 15, Std.int(((1.0 + GetGamepadAxisMovement(GAMEPAD_PLAYER1, GAMEPAD_XBOX_AXIS_RT))/2.0)*70), RED);
					...
					else if (IsGamepadName(GAMEPAD_PLAYER1, PS3_NAME_ID))
					{
						...
						DrawCircle(Std.int(319 + (GetGamepadAxisMovement(GAMEPAD_PLAYER1, GAMEPAD_PS3_AXIS_LEFT_X)*20)), Std.int(255 + (GetGamepadAxisMovement(GAMEPAD_PLAYER1, GAMEPAD_PS3_AXIS_LEFT_Y)*20)), 25, BLACK);

						// Draw axis: right joystick
						DrawCircle(475, 255, 35, BLACK);
						DrawCircle(475, 255, 31, LIGHTGRAY);
						DrawCircle(Std.int(475 + (GetGamepadAxisMovement(GAMEPAD_PLAYER1, GAMEPAD_PS3_AXIS_RIGHT_X)*20)), Std.int(255 + (GetGamepadAxisMovement(GAMEPAD_PLAYER1, GAMEPAD_PS3_AXIS_RIGHT_Y)*20)), 25, BLACK);

						// Draw axis: left-right triggers
						DrawRectangle(169, 48, 15, 70, GRAY);
						DrawRectangle(611, 48, 15, 70, GRAY);
						DrawRectangle(169, 48, 15, Std.int(((1.0 - GetGamepadAxisMovement(GAMEPAD_PLAYER1, GAMEPAD_PS3_AXIS_L2))/2.0)*70), RED);
						DrawRectangle(611, 48, 15, Std.int(((1.0 - GetGamepadAxisMovement(GAMEPAD_PLAYER1, GAMEPAD_PS3_AXIS_R2))/2.0)*70), RED);
					}
					else
					{
					...
					{
						DrawText('AXIS $i: ${GetGamepadAxisMovement(GAMEPAD_PLAYER1, cast i)}', 20, 70 + 20*i, 10, DARKGRAY);
					}
